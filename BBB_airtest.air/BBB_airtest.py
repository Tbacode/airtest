...
touch(home_bt)
if exists(Template(r"tpl1626074230882.png", record_pos=(0.361, -0.617), resolution=(1080, 1920))):
    touch(exists(Template(r"tpl1626074230882.png", record_pos=(0.361, -0.617), resolution=(1080, 1920))))
# 进入球背包
touch((295, 1800))
# 等待滑动
sleep(3)
