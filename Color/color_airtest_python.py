'''
 * @Descripttion : color自动化调度脚本
 * @Author       : Tommy
 * @Date         : 2021-09-01 17:30:01
LastEditors: Please set LastEditors
LastEditTime: 2021-09-07 16:16:46
'''
import os
import requests
import shutil
...
class AirtestPython(object):
    ...
    def report_zip(self, item_log):
        ...
        '''
        start_dir = r'C:/Users/talefun/Documents/airtest/Color/report/{}/static'.format(
            item_log)
        ...
        for dirpath, dirname, filenames in os.walk(start_dir):
            ...
            fpath = dirpath.replace(
                r'C:\Users\talefun\Documents\airtest\Color\report\{}'.format(item_log), '')
    ...
    def report_zip_append(self, file_news, item_log):
        ...
        '''
        zip_dir = r'C:\Users\talefun\Documents\airtest\Color\report\{}\static{}'.format(
            item_log, file_news)
        file_log = r'C:\Users\talefun\Documents\airtest\Color\report\{}'.format(
            item_log)
        file_news = r'C:\Users\talefun\Documents\airtest\Color\report\{}\log.html'.format(
            item_log)
        file_news2 = r'C:\Users\talefun\Documents\airtest\Color\report\{}\log'.format(
            item_log)
    ...
    def post_file(self, wx_url, file_news, item_air):
        ...
        data = {
            ...
            "text": {
                ...
                "content": "http://172.31.60.64/Color_airlog/{}-{}".format(item_air, file_news)
            }
        }
    ...
    def run_main(self, cmd1, cmd2):
        ...
        result = self.is_success(
            r'C:\Users\talefun\Documents\airtest\Color\log\log.txt')
        if result == 1:
...
if __name__ == "__main__":
    ap = AirtestPython()
    airproject_list = [#"color_newuser.air",
                       #"color_setting.air",
                       "color_coloring.air"]
    ...
    for lite_item in airproject_list:
        ...
        '''
        cmd1 = r'python -m airtest run "C:\Users\talefun\Documents\airtest\Color\{}" --device Android://127.0.0.1:5037/HT7941A04009 --log "C:\Users\talefun\Documents\airtest\Color\log"'.format(
            lite_item)
        cmd2 = r'python -m airtest report "C:\Users\talefun\Documents\airtest\Color\{}" --log_root "C:\Users\talefun\Documents\airtest\Color\log" --export "C:\Users\talefun\Documents\airtest\Color\report" --lang zh'.format(
            lite_item)
