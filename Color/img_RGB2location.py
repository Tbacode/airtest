...
LastEditTime: 2021-09-07 16:21:53
'''
...
class RGB2Location(object):
    ...
    def push_img2devices(self):
        os.system(r"adb pull /sdcard/screen_air.jpg C:\Users\talefun\Documents\airtest\Color\screen_air.jpg")
    ...
    def crop_img(self):
        print("进入裁剪")
        Img = cv2.imread(r"C:\Users\talefun\Documents\airtest\Color\screen_air.jpg")
        cropped = Img[325:1300, 0:1080] # 裁剪坐标为[y0:y1, x0:x1]
        cv2.imwrite(r"C:\Users\talefun\Documents\airtest\Color\screen_air_crop.jpg", cropped)
#         return "C:/Users/xt875/Documents/airtest/Color_airtest.air/screen_air_crop.jpg"

    def get_location_node(self, numb):
        self.crop_img()
        Img = cv2.imread(r"C:\Users\talefun\Documents\airtest\Color\screen_air_crop.jpg")  #读入一幅图像
...
#                 sleep(1)
            ...
            if diff_nodes:
                ...
                sleep(1)
                self.run_main()
        if not exists(Template(r"tpl1628835509233.png", record_pos=(-0.007, 0.638), resolution=(1080, 1920))):
            self.run_main()
