...
class RGB2LocationLite(object):
    ...
    def get_app_img(self):
        os.system(r"adb shell screencap -p /sdcard/screen_air_lite.jpg")
        self.push_img2devices()
    def push_img2devices(self):
        os.system(r"adb pull /sdcard/screen_air_lite.jpg C:/Users/xt875/Documents/airtest/LITE_airtest.air/screen_air_lite.jpg")
    ...
    def crop_img(self):
        print("进入裁剪")
        Img = cv2.imread(r"C:/Users/xt875/Documents/airtest/LITE_airtest.air/screen_air_lite.jpg")
        cropped = Img[0:1300, 0:1080] # 裁剪坐标为[y0:y1, x0:x1]
        cv2.imwrite("C:/Users/xt875/Documents/airtest/LITE_airtest.air/screen_air_lite_crop.jpg", cropped)
#         return "C:/Users/xt875/Documents/airtest/Color_airtest.air/screen_air_crop.jpg"

    def get_location_node(self, numb):
        self.crop_img()
        Img = cv2.imread("C:/Users/xt875/Documents/airtest/LITE_airtest.air/screen_air_lite_crop.jpg")  #读入一幅图像
...
#                 sleep(1)
            ...
            if diff_nodes:
                ...
                sleep(1)
                self.run_main()
        if not exists(Template(r"tpl1629346420050.png", record_pos=(-0.001, 0.638), resolution=(1080, 1920))):
            self.run_main()
