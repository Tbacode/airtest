...
class RGB2LocationLite(object):
    ...
    def push_img2devices(self):
        os.system(
            r"adb pull /sdcard/screen_air_lite.jpg C:\Users\talefun\Documents\airtest\Lite\screen_air_lite.jpg")
...
#         return "C:/Users/xt875/Documents/airtest/Color_airtest.air/screen_air_crop.jpg"
    ...
    def get_location_node(self, numb):
        self.crop_img()
        Img = cv2.imread(
            r"C:\Users\talefun\Documents\airtest\Lite\screen_air_lite_crop.jpg")  # 读入一幅图像
...
#                 sleep(1)
            ...
            if diff_nodes:
                ...
                sleep(1)
                self.run_main()
        if not exists(Template(r"lite_coloring.air/tpl1629346420050.png", record_pos=(-0.001, 0.638), resolution=(1080, 1920))):
            self.run_main()
