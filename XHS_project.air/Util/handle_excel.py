 ...
 * @LastEditors  : Tommy
 * @LastEditTime : 2022-05-05 19:05:04
'''
import openpyxl
...
class HandleExcel():
    ...
    def get_excel_data(self, index=None):
        ...
        for i in range(self.get_rows(index)):
            data_list.append(self.get_rows_value(i + 4, index))

        return data_list


excel = HandleExcel(r"C:\Users\talefun\Documents\airtest\XHS_project.air\xhs.xlsx")
